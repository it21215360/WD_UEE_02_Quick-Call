...
public class MainActivityElec extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                viewDialogAdd.showDialog(MainActivityElec.this);
            }
        });
        ...
        buttonhome.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MainActivityElec.this,Home.class);
    ...
    private void readData() {
        ...
        databaseReference.child("USERS").orderByChild("userName").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adapter = new UsersRecyclerAdapter(MainActivityElec.this, usersItemArrayList);
